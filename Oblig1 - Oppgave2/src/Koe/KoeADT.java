...
public interface KoeADT<T> {
    ...
    /**
     * Returnerer elementet foran i køen uten å fjerne det fra køen.
     * @return elementet foran i køen
     * @Empty CollectionException unntak kastes hvis køen allerede er tom */
    T foerste() ;

    /**
     * Returnerer sann hvis køen ikke inneholder noen elementer. * @return sann dersom køen er tom ellers usann
     */
    boolean erTom();

    /**
     * Returnerer antall elementer i køen. * @return antall elementer i køen */
    int antall();
